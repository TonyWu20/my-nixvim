...
return function()
	...
	local icons = {
		...
		git_nosep = require("icons").get("git"),
	...
	local function custom_theme()
		...
		if has_catppuccin then
			...
			local universal_bg = vim.g.my_settings.transparent_background and "NONE" or colors.mantle
			return {
				normal = {
	...
	local utils = {
		...
		abbreviate_path = function(path)
			local home = vim.g.my_globals.home
		...
		gen_hl = function(fg, gen_bg, special_nobg, bg, gui)
			if has_catppuccin then
				return function()
					...
					local nobg = special_nobg and vim.g.my_settings.transparent_background
					return {
