return function()
	...
	dashboard.section.header.val = vim.g.my_settings.dashboard_image
	...
	local leader = " "
	local icons = {
		documents = require("icons").get("documents", true),
	...
	dashboard.section.buttons.val = {
		...
		button("space f p", icons.documents.Word .. "Find patterns", leader, nil, {
			noremap = true,
			silent = true,
			nowait = true,
		}),
